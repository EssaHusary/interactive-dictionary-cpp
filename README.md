...
This is the c++ version of an interactive dictionary I created in which a user can look up the definition of words and apply search filters to their searches. To run it, simply hit the start button in your IDE, but see below for further instructions.
